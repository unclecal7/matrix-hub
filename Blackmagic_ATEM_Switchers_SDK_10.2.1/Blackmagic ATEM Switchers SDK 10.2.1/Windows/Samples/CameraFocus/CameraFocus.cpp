...
int _tmain(int argc, TCHAR* argv[], TCHAR* envp[])
{
	...
	result = CoCreateInstance(CLSID_CBMDSwitcherDiscovery, NULL, CLSCTX_ALL, IID_IBMDSwitcherDiscovery, (void**)&discovery);
	if (result != S_OK)
	{
	...
	_bstr_t ipAddress(_T("192.168.10.240"));
	result = discovery->ConnectTo(ipAddress.GetBSTR(), &switcher, &connectToFailReason);
	discovery->Release();
	if (result != S_OK)
	{
