...
public:
	...
	void onSwitcherDisconnected(const NotifyEventFunc& func) { registerNotifyHandler(bmdSwitcherEventTypeDisconnected, func); }

private:
	std::atomic<ULONG>									m_refCount;
	std::map<BMDSwitcherEventType, NotifyEventFunc> 	m_notifyHandlerFuncMap;
