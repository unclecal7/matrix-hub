...
{
public:
	MediaPlayerCallback(SwitcherMediaPoolAppDelegate* uiDelegate);
...
{
public:
	MediaPlayerMonitor(SwitcherMediaPoolAppDelegate* uiDelegate);
	~MediaPlayerMonitor();
...
{
public:
	StillsCallback(SwitcherMediaPoolAppDelegate* uiDelegate);
...
{
public:
	StillsMonitor(SwitcherMediaPoolAppDelegate* uiDelegate);
	~StillsMonitor();
...
{
public:
	ClipCallback(SwitcherMediaPoolAppDelegate* uiDelegate);
...
{
public:
	ClipMonitor(SwitcherMediaPoolAppDelegate* uiDelegate);
	~ClipMonitor();
...
{
public:
	LockCallback(SwitcherMediaPoolAppDelegate* uiDelegate, int clipIndex = -1); // do not set clipIndex for stills
...
{
public:
	SwitcherCallback(SwitcherMediaPoolAppDelegate* uiDelegate);
...
{
public:
	SwitcherMonitor(SwitcherMediaPoolAppDelegate* uiDelegate);
	~SwitcherMonitor();
