...
MediaPlayerCallback::MediaPlayerCallback(SwitcherMediaPoolAppDelegate* uiDelegate)
...
MediaPlayerMonitor::MediaPlayerMonitor(SwitcherMediaPoolAppDelegate* uiDelegate)
 :	mMediaPlayer(NULL)
{
...
StillsCallback::StillsCallback(SwitcherMediaPoolAppDelegate* uiDelegate)
 :	mUIDelegate(uiDelegate),
	mRefCount(1)
{
}
...
StillsMonitor::StillsMonitor(SwitcherMediaPoolAppDelegate* uiDelegate)
	:	mStills(NULL)
{
...
ClipCallback::ClipCallback(SwitcherMediaPoolAppDelegate* uiDelegate)
 :	mUIDelegate(uiDelegate),
	mRefCount(1)
{
}
...
ClipMonitor::ClipMonitor(SwitcherMediaPoolAppDelegate* uiDelegate)
	:	mClip(NULL)
{
...
LockCallback::LockCallback(SwitcherMediaPoolAppDelegate* uiDelegate, int clipIndex)
 :	mUIDelegate(uiDelegate),
	mRefCount(1),
...
SwitcherCallback::SwitcherCallback(SwitcherMediaPoolAppDelegate* uiDelegate)
 :	mUIDelegate(uiDelegate),
	mRefCount(1)
{
}
...
SwitcherMonitor::SwitcherMonitor(SwitcherMediaPoolAppDelegate* uiDelegate)
:	mSwitcher(NULL)
{
