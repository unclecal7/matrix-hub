...
BMD_CONST REFIID IID_IBMDSwitcher                                 = /* 814ADC33-3B5D-4540-9CA3-78C3F2FEF96D */ { 0x81,0x4A,0xDC,0x33,0x3B,0x5D,0x45,0x40,0x9C,0xA3,0x78,0xC3,0xF2,0xFE,0xF9,0x6D };
BMD_CONST REFIID IID_IBMDSwitcherDiscovery                        = /* 00EED297-E1B5-407A-AE96-6CB93D33B7F2 */ { 0x00,0xEE,0xD2,0x97,0xE1,0xB5,0x40,0x7A,0xAE,0x96,0x6C,0xB9,0x3D,0x33,0xB7,0xF2 };
...
enum BMDSwitcherEventType {
    ...
    bmdSwitcherEventTypeTimecodeSdiOutputEnabledChanged          = /* 'tcsc' */ 0x74637363,
...
public:
    ...
    virtual HRESULT DoesSupportTimecodeSdiOutputEnabledSetting (/* out */ bool* supported) = 0;
    virtual HRESULT GetTimecodeSdiOutputEnabled (/* out */ bool* enabled) = 0;
    virtual HRESULT SetTimecodeSdiOutputEnabled (/* in */ bool enabled) = 0;
