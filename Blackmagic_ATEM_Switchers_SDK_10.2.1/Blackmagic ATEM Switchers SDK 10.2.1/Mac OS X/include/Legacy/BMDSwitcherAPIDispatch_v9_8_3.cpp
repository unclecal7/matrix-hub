...
** -LICENSE-END-
*/
/* BMDSwitcherAPIDispatch_v9_8_3.cpp */

#include "BMDSwitcherAPI_v9_8_3.h"
#include <pthread.h>

#define kBMDSwitcherAPI_BundlePath "/Library/Application Support/Blackmagic Design/Switchers/BMDSwitcherAPI.bundle"

typedef IBMDSwitcherDiscovery_v9_8_3* (*CreateDiscoveryFunc)(void);
...
static void	InitBMDSwitcherAPI (void)
{
	...
	if (bundleURL != NULL)
	{
		...
		if (gBundleRef != NULL)
		{
			gCreateDiscoveryFunc = (CreateDiscoveryFunc)CFBundleGetFunctionPointerForName(gBundleRef, CFSTR("GetBMDSwitcherDiscoveryInstance_0010"));
		}
		CFRelease(bundleURL);
	}
}

IBMDSwitcherDiscovery_v9_8_3* CreateBMDSwitcherDiscoveryInstance_v9_8_3 (void)
{
