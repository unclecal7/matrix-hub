...
** -LICENSE-END-
*/
/* BMDSwitcherAPIDispatch_v8_0_3.cpp */

#include "BMDSwitcherAPI_v8_0_3.h"
#include <pthread.h>

#define kBMDSwitcherAPI_BundlePath "/Library/Application Support/Blackmagic Design/Switchers/BMDSwitcherAPI.bundle"

typedef IBMDSwitcherDiscovery_v8_0_3* (*CreateDiscoveryFunc)(void);
...
static void	InitBMDSwitcherAPI (void)
{
	...
	if (bundleURL != NULL)
	{
		...
		if (gBundleRef != NULL)
		{
			gCreateDiscoveryFunc = (CreateDiscoveryFunc)CFBundleGetFunctionPointerForName(gBundleRef, CFSTR("GetBMDSwitcherDiscoveryInstance_0005"));
		}
		CFRelease(bundleURL);
	}
}
