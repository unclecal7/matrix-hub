...
** -LICENSE-END-
*/
/* BMDSwitcherAPIDispatch_v10_1_1.cpp */

#include "BMDSwitcherAPI_v10_1_1.h"
#include <pthread.h>

#define kBMDSwitcherAPI_BundlePath "/Library/Application Support/Blackmagic Design/Switchers/BMDSwitcherAPI.bundle"

typedef IBMDSwitcherDiscovery_v10_1_1* (*CreateDiscoveryFunc)(void);
...
static void	InitBMDSwitcherAPI (void)
{
	...
	if (bundleURL != NULL)
	{
		...
		if (gBundleRef != NULL)
		{
			gCreateDiscoveryFunc = (CreateDiscoveryFunc)CFBundleGetFunctionPointerForName(gBundleRef, CFSTR("GetBMDSwitcherDiscoveryInstance_0011"));
		}
		CFRelease(bundleURL);
	}
}

IBMDSwitcherDiscovery_v10_1_1* CreateBMDSwitcherDiscoveryInstance_v10_1_1 (void)
{
