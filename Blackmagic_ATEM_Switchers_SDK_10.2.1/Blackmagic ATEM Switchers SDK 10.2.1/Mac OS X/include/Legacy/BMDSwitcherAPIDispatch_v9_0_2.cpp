...
** -LICENSE-END-
*/
/* BMDSwitcherAPIDispatch_v9_0_2.cpp */

#include "BMDSwitcherAPI_v9_0_2.h"
#include <pthread.h>

#define kBMDSwitcherAPI_BundlePath "/Library/Application Support/Blackmagic Design/Switchers/BMDSwitcherAPI.bundle"

typedef IBMDSwitcherDiscovery_v9_0_2* (*CreateDiscoveryFunc)(void);
...
static void	InitBMDSwitcherAPI (void)
{
	...
	if (bundleURL != NULL)
	{
		...
		if (gBundleRef != NULL)
		{
			gCreateDiscoveryFunc = (CreateDiscoveryFunc)CFBundleGetFunctionPointerForName(gBundleRef, CFSTR("GetBMDSwitcherDiscoveryInstance_0008"));
		}
		CFRelease(bundleURL);
	}
}

IBMDSwitcherDiscovery_v9_0_2*				CreateBMDSwitcherDiscoveryInstance_v9_0_2 (void)
{
